...
Pour vérifier que cela tient, il faudrait évaluer l'intégrale, ce qui à priori ne semble pas simple du tout car on intègre une fonction complexe. En utilisant la formule d'Euler, on trouve
...
\begin{figure}[H]
    ...
    \caption{TFI de Rect$(x)$ avec bornes $[-10, 10]$ (à gauche) et $[-50, 50]$ (à droite)}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \caption{TFI de Rect$(x)$ avec bornes $[-100, 100]$ (à gauche) et $[-500, 500]$ (à droite)}
        \end{figure}