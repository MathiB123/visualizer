...
Un autre type de fréquence pertinent est la fréquence angulaire $\omega$, soit le nombre de radians parcourus par unité de temps. Puisqu'on peut représenter $\cos(x)$ et $\sin(x)$ dans le cercle trigonométrique, ces fonctions ont une fréquence angulaire. Pour la trouver, on peut dire que 
