...
Afin d'alléger l'écriture, on écrit que $f(k\tau) = f_k$ pour désigner le $k$ième point. Aussi, on note que $n$ est un entier se promenant entre 0 et $N-1$ par la périodicité de l'exponentielle complexe. Ainsi, (\ref{eq_TFD}) correspond la TFD et on isole un des $f_k$ pour obtenir la transformée de Fourier inverse discrète (TFID).
